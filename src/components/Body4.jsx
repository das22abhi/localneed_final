...
import items_page from '../assets/items_page.jpeg'
    ...
    return (
        <div className='w-full flex justify-center mt-[100px]'>
            <div className='w-[90%] md:min-w-[750px]'>
                <div className='parent-container bg-gradient-to-r from-[#FAB8C4] to-[#fab8c4a1] rounded-[30px] p-10 flex justify-around flex-col-reverse items-center md:flex-row-reverse relative'>
